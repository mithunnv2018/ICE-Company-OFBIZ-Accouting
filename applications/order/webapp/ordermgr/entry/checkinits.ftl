...
<div class="screenlet">
  ...
  <div class="screenlet-body">
      ...
      <input type="hidden" name="productStoreId" value="${defaultProductStore.productStoreId}"/>
      <input type="hidden" name="salesChannelEnumId" value="${defaultSalesChannel.enumId}"/>
...
<!-- REASONTODO : For Ice Factory There is no purchase order hence removed-->
<!-- 
