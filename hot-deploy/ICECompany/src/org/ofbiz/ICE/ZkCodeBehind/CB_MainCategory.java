...
public class CB_MainCategory extends GenericForwardComposer {
	...
	public boolean validateControlsNew()
	{
		 String Error ="";
		 boolean val;
		 Error+= objCommonValidations.TextBoxValidate(txtMainCategory.getText().trim())?"":"Main Category cannot be empty";
	...
	public boolean validateControlsModify()
	{
		 ...
		 Error+= objCommonValidations.TextBoxValidate(txtMainCategory.getText().trim())?"":"Select Main Category";
